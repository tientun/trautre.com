	...
	<table class="datatable">
		...
		<?php foreach ($comments as $comment):?>
			<tr>
				...
				<?php
					echo $this->Html->link($this->Html->image('icons/icon_delete.png',array('alt'=>'Delete Comment', 'title'=>'Delete Comment')),array('action' => 'delete_detail/'.$comment['EntryComment']['id'].'/'.$entry_id), array('escape'=>false, 'class' => 'button_setting'), 'Are you sure you want to remove this comment?');
				?>       
				</td>
			</tr>
		<?php endforeach;?>
