...
class UploadComponent extends Object {
        ...
        function upload ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
            ...
            //create fileName Ramdom
            //$this->_fileName = createRandomString();
        ...
        function image ($file, $type, $size, $output = NULL, $quality = NULL) {
            ...
            // -- check output
            if ($output != 'jpg' && $output != 'png' && $output != 'jpeg' && $output != 'gif') {
        ...
        $chars = "aAbBOpj12fFgGhHiI34567qQraAbRsStTucCnNoUvVwWxXyYzZ";
