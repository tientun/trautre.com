  <div class="box photoDetails">
                            <div class="photoInfo">
                                <h1> Chơi game tốt hay xấu?</h1>
                                <div class="stats">
                                    <span class="views">
                                        Lượt xem:
                                        <span class="number">4.965</span>
                                    </span>
                                    <span class="comments">
                                        Lượt bình luận:
                            ...
                            <div class="uploader">
                                Đăng 3 tiếng trước bởi
                                <div>
                                    <img src="http://s.haivl.com/data/avatar/129643/d2372775cd744cb1a9cb68dd9a2ea232/thumbnail.jpg">
                                    <div class="info">
                                        <a href="/uploader/129643">Ry Natri</a>
                                        <span class="likes" title="lượt thích">17.245</span>
                                    </div>
                                    <div class="clear"> </div>
                                </div>
                            </div>
                            ...
                            <div class="likeButton fixedScroll " >
                                ...
                                <div class="navButtons">
                                    <a class="prev" title="hotkey: ← hoặc Z" href="/photo/639752">Ảnh trước</a>
                                    <a class="next" title="hotkey: → hoặc X" href="/photo/639770">Ảnh sau</a>
                                </div>
                            </div>
                            <div class="clear"> </div>
                            <div class="photoImg">
                                <img alt="Chơi game tốt hay xấu?" src="http://s2.haivl.com/data/photos2/20130620/15832641f72549d4a800627a607ee250/medium-0d555d4556d140a2a45248a55cbf41b7-650.jpg">
                            </div>
                            ...
                            <div class="commentContainer">
                                <h4>
                                    Bình luận
                                    <a class="report" href="/account/login?returnurl=%2fphoto%2f639382%3freport%3d1"> Báo cáo vi phạm</a>
                                </h4>
