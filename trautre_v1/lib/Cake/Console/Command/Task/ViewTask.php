 ...
 */
	protected function _interactive() {
		...
		$interactive = 'y';//$this->in($prompt, array('y', 'n'), 'n');
		...
		$wannaDoScaffold = 'y';//$this->in($prompt, array('y', 'n'), 'y');

		$wannaDoAdmin = 'y';//$this->in(__d('cake_console', "Would you like to create the views for admin routing?"), array('y', 'n'), 'n');
