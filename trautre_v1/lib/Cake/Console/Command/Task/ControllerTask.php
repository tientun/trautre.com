 ...
 */
	protected function _interactive() {
		...
		$doItInteractive = 'y';//$this->in(implode("\n", $question), array('y', 'n'), 'y');

		if (strtolower($doItInteractive) == 'y') {
			$this->interactive = true;
			$useDynamicScaffold = 'n';//$this->in(__d('cake_console', "Would you like to use dynamic scaffolding?"), array('y', 'n'), 'n');
			...
			if (strtolower($useDynamicScaffold) == 'y') {
				...
				$wannaUseSession = 'y';//$this->in(__d('cake_console', "Would you like to use Session flash messages?"), array('y','n'), 'y');
			}
		} else {
			list($wannaBakeCrud, $wannaBakeAdminCrud) = $this->_askAboutMethods();
		}
 ...
 */
	protected function _askAboutMethods() {
		$wannaBakeCrud = 'y';//$this->in(__d('cake_console', "Would you like to create some basic class methods \n(index(), add(), view(), edit())?"),array('y','n'), 'n');
		$wannaBakeAdminCrud = 'y';//$this->in(__d('cake_console', "Would you like to create the basic class methods for admin routing?"),array('y','n'), 'n');
